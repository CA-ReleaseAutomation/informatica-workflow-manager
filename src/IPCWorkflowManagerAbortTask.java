 ...
 */
@ActionDescriptor(
        name = "IPC - Workflow Manager - Abort Task",
		description = "Start an Informatica workflow",
        category="PowerCenter.Workflow Manager" )
    public class IPCWorkflowManagerAbortTask extends Action {
    private static final long serialVersionUID = 1L;
	private static final Logger log = Logger.getLogger(IPCWorkflowManagerAbortTask.class);
	...
	@ParameterDescriptor(
        ...
        defaultValueAsString = ""
            ...
            private String workflowruninstance8;
    ...
    public void settaskinstancepath7(String taskinstancepath7) {
    	this.taskinstancepath7 = taskinstancepath7;
	        ...
	        public String getworkflowruninstance8() {
        return workflowruninstance8;
    }
    
    public void setworkflowruninstance8(String workflowruninstance8) {
    	this.workflowruninstance8 = workflowruninstance8;
    }
	    // Getters and Setters
	...
	private ActionResult getActionResult(com.ca.nolio.rdk.dto.CLIAction action) {
 	...
 	private List<InputParam> getInput() {
			...
			p.setType(VarType.String);
									    			 				...
									    			 				p.setValue( workflowruninstance8 );
	...
	private List<CliCommand> getCliCommands(){
		...
		Script script = null;
					...
					cliCmd.setCommand("pmcmd AbortTask -service ${Service} -d ${Domain} -u ${User} -p ${Password} -f ${Folder} ${Task Instance Path}");											
...
private com.ca.nolio.rdk.dto.CLIAction getCLIAction() {
	...
	action.setName("IPC - Workflow Manager - Abort Task");
