 ...
 */
@ActionDescriptor(
        name = "IPC - Workflow Manager - Get Workflow Log",
		description = "Start an Informatica workflow",
        category="PowerCenter.Workflow Manager" )
    public class IPCWorkflowManagerGetWorkflowLog extends Action {
    private static final long serialVersionUID = 1L;
	private static final Logger log = Logger.getLogger(IPCWorkflowManagerGetWorkflowLog.class);
	...
	defaultValueAsString = "C:\\\\Informatica\\\\9.5.1\\\\clients\\\\PowerCenterClient\\\\CommandLineUtilities\\\\PC\\\\server\\\\bin"
            ...
            private String infacmdpath1 = "C:\\\\Informatica\\\\9.5.1\\\\clients\\\\PowerCenterClient\\\\CommandLineUtilities\\\\PC\\\\server\\\\bin";
    ...
    // Getters and Setters
        public String getinfacmdpath1() {
        return infacmdpath1;
    }
    
    public void setinfacmdpath1(String infacmdpath1) {
    	this.infacmdpath1 = infacmdpath1;
    }
	...
	private ActionResult getActionResult(com.ca.nolio.rdk.dto.CLIAction action) {
 	...
 	private List<InputParam> getInput() {
			...
			p.setName("infacmd path");
             ...
             p.setPrefix("");
			//p.setValue("");
			p.setVariableName("infacmdpath");
			p.setType(VarType.String);

									    			 				p.setValue( infacmdpath1 );
	...
	private List<CliCommand> getCliCommands(){
		...
		Script script = null;
					...
					cliCmd.setCommand("infacmd getworkflowlog -service ${Service} -d ${Domain} -u ${User} -p ${Password} -f ${Folder} ${Workflow} ${Parameter File}");											
...
private com.ca.nolio.rdk.dto.CLIAction getCLIAction() {
	...
	action.setName("IPC - Workflow Manager - Get Workflow Log");
