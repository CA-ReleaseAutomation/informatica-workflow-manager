 ...
 */
@ActionDescriptor(
        name = "IPC - Workflow Manager - Start Workflow",
		description = "Start an Informatica workflow",
        category="PowerCenter.Workflow Manager" )
    public class IPCWorkflowManagerStartWorkflow extends Action {
    private static final long serialVersionUID = 1L;
	private static final Logger log = Logger.getLogger(IPCWorkflowManagerStartWorkflow.class);
	...
	private List<CliCommand> getCliCommands(){
		...
		Script script = null;
					...
					cliCmd.setCommand("pmcmd startworkflow -service ${Service} -d ${Domain} -u ${User} -p ${Password} -f ${Folder} ${Workflow} ${Parameter File}");											
...
private com.ca.nolio.rdk.dto.CLIAction getCLIAction() {
	...
	action.setName("IPC - Workflow Manager - Start Workflow");
